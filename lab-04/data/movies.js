...
const getMovieById = async (id) => {
  if(!id){throw "Error: Must provide a vaild id"}
  if(typeof id !== 'string'){throw "Error: Must provide a type string id"}
  if(id.trim().length === 0){throw "Error: Must provide a valid id without spaces"}
  id = id.trim();
